...
class DetailViewController: UIViewController {
    ...
    private func setupConstraints() {
        NSLayoutConstraint.activate([
            ...
            reciptImage.leadingAnchor.constraint(equalTo: contentStackView.leadingAnchor, constant: 16),
            reciptImage.trailingAnchor.constraint(equalTo: contentStackView.trailingAnchor, constant: -16),
            ratingStack.leadingAnchor.constraint(equalTo: contentStackView.leadingAnchor, constant: 16),
            
            instructionsLabel.leadingAnchor.constraint(equalTo: contentStackView.leadingAnchor,constant: 24),
            ingredientsLabelsStack.leadingAnchor.constraint(equalTo: contentStackView.leadingAnchor, constant: 16),
            ingredientsLabelsStack.trailingAnchor.constraint(equalTo: contentStackView.trailingAnchor,constant: -16),
